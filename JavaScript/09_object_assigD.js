...
print();
console.log(
  "Here calling function professor.totalDegrees(): ",
  professor.totalDegrees()
);
print();
professor.totalExperience = 14;
console.log(
  "After adding totalExperience & Accessing the property via 'professor.totalExperience': " +
...
print();
console.log(
  "Last element of the certificate array: ",
